...
| 11 | Dist path resolution correctness | done | `test-dist-path-validation.js`, `docs/USAGE.md`, `docs/TROUBLESHOOTING.md` | Docs validate runtime path usage from `dist/`. |
...
| 15 | Cross-CLI sync dry-run/apply safety | done | `scripts/sync-configs.js`, `test-sync-configs-mode-validation.js`, `package.json`, `docs/USAGE.md` | Explicit `--apply`, safe dry-run default, invalid flag guard. |
